...
export default function Testimonials() {
  ...
  return (
    <section className="py-20 bg-brand-bg overflow-x-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Google Review sekcija - ispod recenzija sa punom širinom */}
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <div className="flex flex-col items-center justify-center space-y-4 bg-white rounded-2xl px-8 py-6 shadow-lg max-w-2xl mx-auto">
            {/* Google Review logo */}
